...
< h1 > condition simple: si </ h1 >
< p > On vérifie si 1 condition est remplie </ p >
<? php
...
< p > On vérifie si 1 condition est remplie SINON (else) on effectue une autre action </ p >
<? php
...
<? php
// faites une ternaire sur hasard avec les résultats de l'exemple précédent mis dans une variable, la condition est que $ hasard est ou plus petit que 5 ou plus grand ou égal à 5
...
// si hasard est plus grand ou égal à 5
    ...
    if ( $ hasard % 2 ) {
        echo  $ hasard . "est plus grand ou égal à 5 ​​et est impaire" ;
        // si hasard est paire
    } else {
        echo  $ hasard . "est plus grand ou égal à 5 ​​et est paire" ;
    }
}
?>
</ h5 >
< h1 > condition sinon si: elseif ou else if </ h1 >
< p > On vérifie si 1 condition est remplie SINON SI (elseif) on vérifie une autre condition, SINON on effectue une action par défaut </ p >
<? php
